...
int  __stdcall glutCreateMenu(void (__cdecl *func)(int value));
void __stdcall glutAddMenuEntry(const char* label, int value);
void __stdcall glutAttachMenu(int button);
